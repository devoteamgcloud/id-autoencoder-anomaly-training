...
def save_model_and_reports(
    ...
    blob.upload_from_filename(f"{model_name}")
    ...
    if history:
        ...
        blob.upload_from_filename(f"{args.model_name}_{args.curr_date_str}.png")
    ...
    blob.upload_from_filename(f"{args.model_name}_{args.curr_date_str}_error_distribution.png")
